...
$string['allowstateforrole'] = 'Allow users with role {$a->fromrole} to set workflow state {$a->state}';
...
$string['configallowstateforrole'] = 'You can allow people who have the roles on the top to set workflow state for database records';
