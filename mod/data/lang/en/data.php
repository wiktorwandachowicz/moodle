...
$string['actionnameexists'] = 'Action with this name for selected start state already exists ({$a})';
...
$string['allowstateforrole'] = 'Allow users with role {$a->fromrole} for workflow actions in state {$a->state}';
...
$string['availableactions'] = '[Actions] : Start state &gt;&gt; Target state';
$string['blank'] = 'Blank';
...
$string['configallowstateforrole'] = 'You can allow people who have the roles on the top to perform workflow actions in certain state for database records';
...
$string['createworkflow'] = 'Create workflow';
...
$string['data:useworkflow'] = 'Change workflow state for database record';
$string['data:manageworkflows'] = 'Manage workflows';
$string['data:superviseworkflow'] = 'Receive notifications about changes of workflow state for database records';
$string['date'] = 'Date';
...
$string['deleteactionconfirm'] = 'Are you sure you want to delete this action? {$a}';
$string['deletenotenrolled'] = 'Delete entries by users not enrolled';
$string['deleteselectedaction'] = 'Delete selected action';
$string['deleteselectedstate'] = 'Delete selected state';
$string['deleteselectedworkflow'] = 'Delete selected workflow';
$string['deletestate'] = 'Delete state';
$string['deletestateconfirm'] = 'Are you sure you want to delete this state? {$a}';
$string['deletewarning'] = 'Are you sure you want to delete this preset?';
$string['deleteworkflow'] = 'Delete workflow';
$string['deleteworkflowconfirm'] = 'Are you sure you want to delete this workflow? {$a}';
...
$string['erroreditaction'] = 'Error while editing workflow action';
$string['erroreditstate'] = 'Error while editing workflow state';
$string['erroreditworkflow'] = 'Error while editing workflow';
...
$string['invalidstateid'] = 'Incorrect state ID';
$string['invalidurl'] = 'The URL you just entered is not valid';
$string['invalidworkflowid'] = 'Incorrect workflow ID';
...
$string['localworkflow'] = 'Workflow for course';
$string['localworkflow_help'] = 'Determine if workflow is visible only in current course, or if it can be used site-wide. Only administrators can change this setting.';
...
$string['nodelete'] = 'Deleting this record is not allowed';
$string['noedit'] = 'Editing this record is not allowed';
...
$string['selectedworkflow'] = 'Selected workflow:';
$string['showall'] = 'Show all entries';
$string['showwfstates'] = 'Show states';
$string['showtargetsforstate'] = 'Show target states';
$string['single'] = 'View single';
$string['singletemplate'] = 'Single template';
$string['startstate'] = 'Start state';
$string['startstates'] = 'Start states';
$string['state'] = 'State';
...
$string['targetstate'] = 'Target state';
...
$string['workflowenable'] = 'Enable workflow';
$string['workflowname'] = 'Workflow name';
$string['workflownameexists'] = 'Workflow with this name already exists ({$a})';
$string['workflows'] = 'Workflows';
$string['workflowstate'] = 'Workflow state';
